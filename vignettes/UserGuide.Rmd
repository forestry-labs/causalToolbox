...
```{r, several learners, cache=FALSE}
set.seed(50245181)
...
# Package structure and detailed example
...
```{r, simulated Example 2, cache = FALSE}
...
```{r, Example 2 run experiments, cache = FALSE}
...
```{r, Example 2 get CIs, cache = FALSE}
ci_srf <- CateCI(tl_rf, feature_test, B = 10, verbose = FALSE)
